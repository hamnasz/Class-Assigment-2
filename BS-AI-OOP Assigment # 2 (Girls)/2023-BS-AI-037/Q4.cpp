...
int main() {
    manager m;
    m.setData("Eman", 12907);
    m.setCompensation(6500, employee2::MONTHLY);
    m.setTitle("Project Manager");

    scientist s;
    s.setData("Qandeel", 28766);
    s.setCompensation(8000, employee2::MONTHLY);
    s.setPublications(15);

    laborer l;
    l.setData("Sehrish", 16567);
    l.setCompensation(30, employee2::HOURLY);
